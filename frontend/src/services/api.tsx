...
export const dataService = {
  ...
  getMetadataDeidentified: async (): Promise<MetadataResponse> => {
    const response = await apiClient.get<MetadataResponse>('/metadata/deidentified/');
    return response.data;
  },
  ...
  getDataDeidentified: async (
    ...
    const response = await apiClient.get<DataResponse>('/data/deidentified/', {
      params,
    });
    return response.data;
  },
  ...
  updateDataDeidentified: async (rowIndex: number, columnName: string, value: any): Promise<any> => {
    const response = await apiClient.post('/data/deidentified/update/', {
      row_index: rowIndex,
      column_name: columnName,
      value: value,
    });
  ...
  updateDataDeidentifiedByPatient: async (patientNo: string, interventionDate: string, columnName: string, value: any): Promise<any> => {
    const response = await apiClient.post('/data/deidentified/update-by-patient/', {
